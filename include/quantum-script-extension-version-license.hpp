...
#define QUANTUM_SCRIPT_EXTENSION_VERSION_LICENSE_HPP
...
namespace Quantum {
	namespace Script {
		namespace Extension {
			namespace Version {
				namespace License {
					QUANTUM_SCRIPT_EXTENSION_VERSION_EXPORT const char *content();
					QUANTUM_SCRIPT_EXTENSION_VERSION_EXPORT const char *shortContent();
				};
			};
		};
	};
